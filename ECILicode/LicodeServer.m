...
static NSString *kLicodeServerURLString = @"http://192.168.1.25:3001/createToken/";
static NSString *kLicodeRoomId = @"57ced7acb831f12276f1afcc";
//static NSString *kLicodeRoomId = @"622982043";
...
- (void)obtainTalkCloudToken:(NSString *)username completion:(void (^)(BOOL, NSString *))completion {
